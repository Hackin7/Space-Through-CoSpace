...
int ignorePurple[3]={89,41,180};
int objRange=30;

int depositOrange[3] = {217,121,61};
...
bool objCollectDeposit(bool collectBlue,bool collectRed,bool collectBlack,bool deposit){
	LED_1 =0;
	if (LoadedObjects<6){
		if (colorLeftCheck(ignorePurple, objRange)&&colorRightCheck(ignorePurple, objRange)){return false;}
...
class World1Objects:public ObjectCollection{
	public:
...
int depositOrange[3] = {235,148,30};//{217,121,61};
int slowarea[3] = {167,182,232};//{143,151,197};
int depRange = 35;
