...
bool boundary(int border){
    ...
    if(PositionX1<=x1 && 0<=Compass && Compass <90){WheelLeft=0;WheelRight=-3;return true;}
    else if(PositionX1<=x1 && 90-range<=Compass && Compass <180+range){WheelLeft=-3;WheelRight=0;return true;}
    else if(PositionX1>=x2 && 180-range<=Compass && Compass <270+range){WheelLeft=0;WheelRight=-3;return true;}
    else if(PositionX1>=x2 && 270-range<=Compass && Compass <=360+range){WheelLeft=-3;WheelRight=0;return true;}
    else if (PositionY1<=y1 && 90-range <=Compass && Compass <=180+range){
        WheelLeft=0;WheelRight=-3;return true;
    }
    else if (PositionY1<=y1 && 180-range<=Compass && Compass <=270+range){
        WheelLeft=-3;WheelRight=0;return true;
    }
