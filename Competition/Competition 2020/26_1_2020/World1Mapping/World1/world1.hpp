...
ZoneNodes z0(&location0);
Cycle cycle0(&location0,&z0,&mapping0);
...
static void Game0(){
	...
	bool collectBlue = w1Obj.LoadedObjects<6 && w1Obj.LoadedBlue<2;//true;
	bool collectRed = w1Obj.LoadedObjects<6 && w1Obj.LoadedRed<2;//true;
	bool collectBlack = w1Obj.LoadedObjects<6 && w1Obj.LoadedBlack<2;//true;
    ...
    else cycle0.collectObjects(!collectRed,!collectBlue, !collectBlack);
    if (Time > 180){
			Teleport = 2;
			LoadedObjects=0;
	}
