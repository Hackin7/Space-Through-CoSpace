...
cost[12][13] = 2;
cost[12][17] = 2;
cost[2][1] = 3;cost[3][2] = 3;cost[4][3] = 5;cost[5][4] = 4;cost[9][4] = 2;cost[10][4] = 3;cost[10][9] = 3;cost[10][5] = 2;cost[11][10] = 1;cost[12][11] = 2;cost[7][6] = 3;cost[12][6] = 2;cost[13][6] = 3;cost[13][7] = 2;cost[12][7] = 3;cost[14][5] = 4;cost[14][10] = 3;cost[17][10] = 2;cost[18][10] = 4;cost[18][11] = 2;cost[18][12] = 2;cost[18][17] = 3;cost[19][18] = 1;cost[24][19] = 1;cost[8][1] = 3;cost[8][2] = 3;cost[15][8] = 1;cost[20][15] = 1;cost[25][20] = 1;cost[31][25] = 3;cost[38][31] = 2;cost[39][38] = 3;cost[40][39] = 2;cost[40][33] = 2;cost[33][32] = 2;cost[40][32] = 3;cost[39][33] = 3;cost[39][32] = 2;cost[32][31] = 3;cost[38][32] = 4;cost[39][31] = 4;cost[42][41] = 2;cost[43][42] = 3;cost[44][43] = 1;cost[44][37] = 1;cost[43][36] = 3;cost[43][35] = 5;cost[36][35] = 3;cost[42][36] = 5;cost[42][35] = 3;cost[35][34] = 2;cost[41][34] = 2;cost[42][34] = 3;cost[41][35] = 3;cost[36][30] = 1;cost[30][24] = 1;cost[35][29] = 2;cost[29][23] = 2;cost[23][22] = 2;cost[29][22] = 2;cost[28][23] = 2;cost[26][25] = 2;cost[27][26] = 2;cost[28][27] = 2;cost[29][28] = 2;cost[28][22] = 2;cost[31][26] = 5;cost[32][25] = 5;cost[26][21] = 1;cost[21][16] = 1;cost[16][14] = 1;cost[32][26] = 3;cost[33][27] = 2;cost[33][26] = 3;cost[32][27] = 3;cost[34][27] = 3;cost[33][28] = 3;cost[34][33] = 2;cost[34][28] = 2;cost[35][28] = 3;cost[34][29] = 3;cost[14][9] = 1;cost[13][12] = 2;cost[17][12] = 2;
}

int pathLength = 1;
int pathCoordinates[1000][2];
int dijkstra(int G[MAX][MAX],int cordinates[MAX][2],int n,int startnode,int endnode);
int dijkstra(int G[MAX][MAX],int coordinates[MAX][2],int n,int startnode, int endnode)
{
	...
	for(i=0;i<n;i++)
		if(i!=startnode && i==endnode)
		{
            ...
            int counter = 0;
            //int pathCoordinates[pathLength][2];
            //pathCoordinates[0][0]=pathLength;
            ...
            j=i;
			int c = 0;
            pathCoordinates[c][0] = coordinates[j][0];
			pathCoordinates[c][1] = coordinates[j][1];
			printf("(%d,%d)",pathCoordinates[c][0],pathCoordinates[c][1]);
			do{
				j=pred[j];
				c++;
				printf("<-%d",j);
				pathCoordinates[c][0] = coordinates[c][0];
                pathCoordinates[c][1] = coordinates[c][1];
                printf("(%d,%d)",pathCoordinates[c][0],pathCoordinates[c][1]);
			}while(j!=startnode);
			return distance[i];
	}
...
void startDijkstra(bool deposit){
    //Start Node
    setCostValues();
    int startNode = shortestdistance(PositionX,PositionY);
    printf("\nStartNode: %d\n",startNode);
    //If Loaded
    int depositNodes[4] = {14, 21, 24, 36};
    unsigned int minDist = UINT_MAX;int endNode = depositNodes[0];
    if (deposit){
        for (int i=0;i<4;i++){
        ...
        endNode = shortestdistance(SuperObjX,SuperObjY);
    }

    printf("\nendNode: %d\n",endNode);
    int v = dijkstra(cost,coordinates,MAX,startNode,endNode);
    toNode = pathLength-1;

}
void moveDijkstra(int x, int y){
    printf("Dijkstra On\n");
    if (toNode==-1 && !reached(x-5,y-5,5)){
        rotateTo(angle(x, y));
        return;
    }
    if (reached(pathCoordinates[toNode][0],pathCoordinates[toNode][1],5)){
            toNode--;
    }

    printf("At %d: To(%d,%d)\n",toNode, pathCoordinates[toNode][0],pathCoordinates[toNode][1]);
    rotateTo(angle(pathCoordinates[toNode][0],pathCoordinates[toNode][1]));
    //return !reached(x-5,y-5,5)
}
