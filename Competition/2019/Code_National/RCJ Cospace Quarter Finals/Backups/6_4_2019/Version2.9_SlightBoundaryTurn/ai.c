// Time: 2019-04-06 16:50:28.713486
...
bool boundary(){
    ...
    if (yreached(y1,5) && 90<=Compass && Compass <180){
        WheelLeft=3;WheelRight=0;
    }
    else if (yreached(y1,5) && 180<=Compass && Compass <=270){
        WheelLeft=0;WheelRight=3;
    }
    else if (yreached(y2,5) && (Compass > 270)){
        WheelLeft=3;WheelRight=0;
    }
    else if (yreached(y2,5) && (Compass < 90)){
        WheelLeft=0;WheelRight=3;
    }

    else if ((xreached(x1,5) && 0<=Compass && Compass <180)||
