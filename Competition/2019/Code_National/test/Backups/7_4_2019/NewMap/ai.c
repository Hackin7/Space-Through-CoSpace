// Time: 2019-04-07 10:38:11.972628
...
{
	if (US_Front < 15 && US_Left < 15 && US_Right < 15){		 //Full Turn
	...
	else if (US_Left<30&&US_Right<30 &&US_Front>50) // go through wall
	{
		if (US_Left<15)
		{
			WheelLeft=4;
...
#define OBJPOINTS 4
int objectPoints[OBJPOINTS] = {25,43,25,45};//2,
int objectPointsSize[OBJPOINTS][2] = {{20,20},{20,20},{20,20},{20,20}};
