// Time: 2019-04-06 15:46:56.758709
...
int objectPointsSize[OBJPOINTS][2] = {{50,50},{50,50},{15,15},{50,50},{50,50},{15,15}};
/*
#define REDPOINTS 2
...
void depositDijkstra(){
    if (LoadedObjects >= 4 || LoadedSuperObj > 0){
        ...
        if (reached(coordinates[depositNode][0],coordinates[depositNode][1],20,20)){
                WheelLeft=0;WheelRight=0;
