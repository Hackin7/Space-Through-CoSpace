...
static void Game1()
{
	//if (PositionX==0 || PositionY==0){PositionX = prevX;PositionY=prevY;return;}
	...
	else if (PositionX==0 || PositionY==0){}//}PositionX = prevX;PositionY=prevY;return;}//WheelLeft=3;WheelRight=3;return;}
