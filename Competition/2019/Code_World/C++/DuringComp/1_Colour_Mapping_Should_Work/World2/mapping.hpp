...
void colormap(int x, int y)
{
  ...
  // unfixed location of the stuff, only probability, can coexist
    if (w2Obj.isCollectedRed())//colorCheck(w2Obj.objRed,10))
		{rectfill(redcol,findmax(PositionX-30,0),findmin(PositionX+30,360),findmax(PositionY-20,0),findmin(PositionY+20,270));}
  else if (w2Obj.isCollectedBlue())//colorCheck(w2Obj.objBlue,10))
	{rectfill(cyancol,findmax(PositionX-30,0),findmin(PositionX+30,360),findmax(PositionY-20,0),findmin(PositionY+20,270));}
  else if (w2Obj.isCollectedBlack())//colorCheck(w2Obj.objBlack,10))
	{rectfill(blackcol,findmax(PositionX-30,0),findmin(PositionX+30,360),findmax(PositionY-20,0),findmin(PositionY+20,270));}
