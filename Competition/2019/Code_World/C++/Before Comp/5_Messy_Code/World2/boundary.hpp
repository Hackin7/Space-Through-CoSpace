...
bool inBoundary(){
	return (inLowerBound() || inUpperBound() ||  inLeftBound() || inRightBound());
}
bool boundary(){
...
bool downFromLeft(){return (180 < Compass && Compass <= 270);}
bool downFromRight(){return (90 < Compass && Compass <= 180);}
bool upFromLeft(){return (270 < Compass && Compass <= 360);}
bool upFromRight(){return (0 < Compass && Compass <= 90);}
